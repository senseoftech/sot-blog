...
- « Mets à jour FluentValidation partout » devient, pour [un agent]({{ site.baseurl }}/fr/2026/07/21/copilot-cli-1-sortez-copilot-de-l-ide/), **l'édition d'une ligne dans un fichier** — au lieu d'une chasse aux csproj avec le risque d'en rater un.
