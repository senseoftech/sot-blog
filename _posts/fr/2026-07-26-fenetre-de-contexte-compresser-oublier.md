...
- **Copilot CLI** fait pareil [à 95 % de la jauge]({{ site.baseurl }}/fr/2026/07/22/copilot-cli-2-le-quotidien/), et `/compact` le déclenche à la demande.
...
Le miroir du précédent : ne jamais *tout* poser sur le bureau au départ. C'est [le RAG et son bibliothécaire]({{ site.baseurl }}/fr/2026/07/18/rag-embeddings-expliques-simplement/) — les trois bons extraits au bon moment — mais aussi la mécanique quotidienne des agents : Copilot CLI ne charge pas votre dépôt entier, il fait des recherches ciblées et n'ouvre que les fichiers pertinents. Le *just-in-time context* : la bonne information, au bon moment, en petite quantité.

Et c'est l'argument caché de [l'architecture en tranches]({{ site.baseurl }}/fr/2026/07/25/vibe-engineering-vertical-slice-architecture/) : une fonctionnalité qui tient dans un dossier, c'est un dossier qui tient sur le bureau.

## Pattern 6 : les bureaux séparés — déléguer pour ne pas encombrer

Le pattern d'équipe : chaque spécialiste travaille sur **son propre bureau**, et ne rapporte au chef que sa conclusion. L'agent *Explore* de [Copilot CLI]({{ site.baseurl }}/fr/2026/07/23/copilot-cli-3-l-equipe-dans-le-terminal/) fouille la codebase dans son coin et revient avec trois paragraphes — les 50 000 tokens d'exploration n'ont **jamais touché** votre contexte principal. Même logique chez [Agent Framework]({{ site.baseurl }}/fr/2026/07/11/microsoft-agent-framework-equipe-agents-ia/) : l'isolation de contexte est une forme de compression.
