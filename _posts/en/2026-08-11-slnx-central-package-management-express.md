...
- "Update FluentValidation everywhere" becomes, for [an agent]({{ site.baseurl }}/2026/07/21/copilot-cli-1-take-copilot-out-of-the-ide/), **editing one line in one file** — instead of a csproj hunt with the risk of missing one.
