...
Level 400, episode 7. In [RAG explained]({{ site.baseurl }}/2026/07/15/rag-embeddings-explained-simply/) then [built in .NET]({{ site.baseurl }}/2026/07/28/build-your-rag-in-dotnet/), we called `SearchAsync(queryVector, top: 5)` and — magic — the five neighbors came up. An architect distrusts magic: **how do you find the 5 nearest among ten million vectors, in 20 milliseconds?**
