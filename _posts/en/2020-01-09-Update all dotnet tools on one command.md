...
Unfortunately, to date there is no "```dotnet tool update --all```" command to update all the packages at the same time.
Here is the PowerShell command that I use to update all of them while sitting back in my seat:
<!--more-->
