...
If, like me, you want a private image repository to store your Docker projects, using Azure Container Registry is a solution.
...
* Go to the [Azure Portal](https://portal.azure.com) > Click on __Create a resource__

![step-1](/images/posts/acr-1.PNG)

* Search for "__Container Registry__" in the search box; the result will show you an item called __Container Registry__ published by __Microsoft__.

![step-2](/images/posts/acr-2.PNG)

Azure will give you a small description of what an __Azure Container Registry__ is, and you can create a new one by clicking on the "__Create__" button.
...
Click on "__Create__" and wait for Azure to complete the creation of your new __Azure Container Registry__.
...
* Go to the "__Access keys__" section, in order to retrieve the keys for the next steps.
...
Begin by logging in to your Azure ACR subscription:
...
Great! We have set up your environment; our next step will be to push an image:
...
Ok, I agree it is quite annoying to build, tag and push on every modification you make. You can go further by using [Visual Studio.com](https://visualstudio.microsoft.com) to publish the image in a __Continuous Integration__ way.
For my part, I created a bat file (available [here](https://github.com/aclerbois/aclerbois.acr.console/blob/master/publish.bat)) to automate the command line a little bit.

I hope you enjoyed reading this article; feel free to reach out if you have any remarks or questions.
