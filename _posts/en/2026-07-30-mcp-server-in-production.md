...
The last mile: distribution. Once the URL is stable, [`.github/mcp.json`]({{ site.baseurl }}/2026/07/23/copilot-cli-3-the-team-in-the-terminal/) in the team's repositories:
